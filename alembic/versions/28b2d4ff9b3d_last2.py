...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        None, "items", "products", ["product"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "items", "orders", ["order"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "items", sa.Column("order_id", sa.INTEGER(), autoincrement=False, nullable=True)
    )
    op.drop_constraint(None, "items", type_="foreignkey")
    op.drop_constraint(None, "items", type_="foreignkey")
    op.create_foreign_key(
        "items_product_id_fkey",
        "items",
        "products",
        ["product_id"],
        ["id"],
