...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'items', 'products', ['product_id'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('orders_user_fkey', 'orders', 'users', ['user'], ['id'], ondelete='CASCADE')
    op.drop_column('orders', 'user_id')
    op.add_column('items', sa.Column('product', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('items', sa.Column('order', sa.INTEGER(), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'items', type_='foreignkey')
    op.drop_constraint(None, 'items', type_='foreignkey')
    op.create_foreign_key('items_product_fkey', 'items', 'products', ['product'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('items_order_fkey', 'items', 'orders', ['order'], ['id'], ondelete='CASCADE')
